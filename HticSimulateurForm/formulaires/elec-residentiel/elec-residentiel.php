...
<div class="htic-simulateur-wrapper" data-type="elec-residentiel">
    ...
    <!-- Modal Tempo Résidentiel - À ajouter avant la fermeture du formulaire -->
    <div class="tempo-modal-overlay" id="tempoModal-residentiel" style="display: none;">
        <div class="tempo-modal-container">
            <div class="tempo-modal-header">
                <h2>
                    <span class="tempo-modal-icon">⚡</span>
                    L'option Tempo - Tarif dynamique
                </h2>
                <button type="button" class="tempo-modal-close" onclick="closeTempoModal('residentiel')">&times;</button>
            </div>
            
            <div class="tempo-modal-body">
                <div class="tempo-intro">
                    <p class="tempo-description">
                        <strong>Tempo</strong> est un tarif résidentiel qui varie selon les jours de l'année, permettant d'importantes économies en adaptant sa consommation.
                    </p>
                </div>
                ...
                <div class="tempo-advantages">
                    <h3>Avantages de Tempo :</h3>
                    <div class="advantages-grid">
                        <div class="advantage-item">
                            <div class="advantage-icon">💰</div>
                            <div>
                                <h4>Économies importantes</h4>
                                <p>Jusqu'à 30% d'économies avec une consommation adaptée</p>
                            </div>
                        </div>
                        <div class="advantage-item">
                            <div class="advantage-icon">📱</div>
                ...
                <div class="tempo-tips">
                    <h3>Comment bien utiliser Tempo :</h3>
                    <ul>
                        ...
                        <li><strong>Jours rouges :</strong> Réduisez au maximum (chauffage, eau chaude, électroménager)</li>
                ...
                <div class="tempo-alert">
                    ...
                    <div class="alert-content">
                        ...
                        <p>Tempo nécessite un compteur Linky et une adaptation de vos habitudes de consommation pour être rentable.</p>
                    </div>
                </div>
            </div>
            
            <div class="tempo-modal-footer">
                <button type="button" class="btn-secondary" onclick="closeTempoModal('residentiel')">Fermer</button>
